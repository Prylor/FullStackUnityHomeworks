...
{
    public class GlobalSceneEntityPool
    {
        private struct Pool
        {
        ...
        public GlobalSceneEntityPool(Transform container)
        {
        ...
        {
            string objName = this.GetName(prefab);
        ...
        protected virtual string GetName(SceneEntity entity)
        {
            //Remove '(n)' pattern:
